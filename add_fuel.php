<!DOCTYPE html>
<!-- saved from url=(0039)http://pump.thesoftking.com/fuel-create -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <title>Fuel Create</title>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content" style="min-height:574px">
            <h3 class="page-title">Create Fuel </h3>
            <hr>
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="POST" action="add_fuel.php" accept-charset="UTF-8" class="form-horizontal"><input name="_token" type="hidden" value="jYIgDbpaJDW706f07wEEauLhsJylpRhO0qc8cjTf">
                    <div class="form-body">
