<!DOCTYPE html>
<!-- saved from url=(0043)http://pump.thesoftking.com/currency-create -->
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="POST" action="add_currency.php" accept-charset="UTF-8" class="form-horizontal"><input name="_token" type="hidden" value="jYIgDbpaJDW706f07wEEauLhsJylpRhO0qc8cjTf">
                    <div class="form-body">
