<!DOCTYPE html>
<!-- saved from url=(0039)http://pump.thesoftking.com/menu-create -->
...
<div class="page-header navbar navbar-fixed-top">
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="add_menu.php">
                <img src="./img/logo.png" class="logo-default" alt="-" style="width: 150px; height: 60px;">
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content" style="min-height:616px">
            <h3 class="page-title">Create Menu Setting </h3>
            <hr>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    <form method="POST" action="add_menu.php" accept-charset="UTF-8"><input name="_token" type="hidden" value="encQ4wMYnstwFzZCGpXWPRoDf3JkTdS4ECvFHirU">
                    <div class="form-body">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control input-lg" name="name" value="" type="text">
                                </div>
                            </div>
                        </div>
