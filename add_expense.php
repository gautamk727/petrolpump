<!DOCTYPE html>
<!-- saved from url=(0042)http://pump.thesoftking.com/expense-create -->
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="add_expense.php">
                <img src="./img/logo.png" class="logo-default" alt="-" style="height:60px; width: 60px;">
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content" style="min-height:520px">
            <h3 class="page-title">Create New Expense </h3>
            <hr>
        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="POST" action="" accept-charset="UTF-8" class="form-horizontal"><input name="_token" type="hidden" value="encQ4wMYnstwFzZCGpXWPRoDf3JkTdS4ECvFHirU">
                    <div class="form-body">

                        <div class="form-group">
                            <label class="col-sm-3 control-label">Fule Name: </label>

                            <div class="col-sm-6">
                                <select name="fule_name" id="" class="form-control input-lg" required="">
                                    <option value="">Select One</option>
                                    <option value="Petrol">Petrol</option>
                                    <option value="Diesel">Diesel</option>
                                    <option value="Powre Petrol">Powre Petrol</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Total Fuel Price: </label>

                            <div class="col-sm-6">
                                <input name="rate" value="" class="form-control input-lg" type="text" required="" placeholder="Expense Reason">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> Total FUel Quantity: </label>

                            <div class="col-sm-6">
                                <input name="quty" value="" class="form-control input-lg" type="text" required="" placeholder="Expense Reason">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-offset-3 col-md-6">
                                    <button type="submit" name="submit" class="btn blue btn-block margin-top-10"><i class="fa fa-paper-plane"></i> Create New Expense</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
//$query="INSERT INTO expense_info VALUES ('','$name','$rate','$Quantity','$date')";



  $update ="UPDATE expense_info SET fule_name='$name',rate='$rate', qantity='$Quantity', date='$date' WHERE fule_name='$name'";
