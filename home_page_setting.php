<!DOCTYPE html>
<!-- saved from url=(0045)http://pump.thesoftking.com/home-page-setting -->
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content" style="min-height:509px">
            <h3 class="page-title">Home Page Setting </h3>
            <hr>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body form">
                    <form method="POST" action="home_page_setting.php" accept-charset="UTF-8" role="form" class="form-horizontal"><input name="_method" type="hidden" value="PUT"><input name="_token" type="hidden" value="encQ4wMYnstwFzZCGpXWPRoDf3JkTdS4ECvFHirU">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="form-control input-lg" name="top_title" value="We are Experienced Experts" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input class="form-control input-lg" name="bottom_title" value="SERVICE WE OFFER" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <ul class="wysihtml5-toolbar" style=""><li class="dropdown"><a class="btn default dropdown-toggle" data-toggle="dropdown" href="http://pump.thesoftking.com/home-page-setting#"><i class="icon-font"></i>&nbsp;<span class="current-font">Normal text</span>&nbsp;<b class="caret"></b></a><ul class="dropdown-menu"><li><a data-wysihtml5-command="formatBlock" data-wysihtml5-command-value="div" tabindex="-1" href="javascript:;" unselectable="on">Normal text</a></li><li><a data-wysihtml5-command="formatBlock" data-wysihtml5-command-value="h1" tabindex="-1" href="javascript:;" unselectable="on">Heading 1</a></li><li><a data-wysihtml5-command="formatBlock" data-wysihtml5-command-value="h2" tabindex="-1" href="javascript:;" unselectable="on">Heading 2</a></li><li><a data-wysihtml5-command="formatBlock" data-wysihtml5-command-value="h3" tabindex="-1" href="javascript:;" unselectable="on">Heading 3</a></li><li><a data-wysihtml5-command="formatBlock" data-wysihtml5-command-value="h4" href="javascript:;" unselectable="on">Heading 4</a></li><li><a data-wysihtml5-command="formatBlock" data-wysihtml5-command-value="h5" href="javascript:;" unselectable="on">Heading 5</a></li><li><a data-wysihtml5-command="formatBlock" data-wysihtml5-command-value="h6" href="javascript:;" unselectable="on">Heading 6</a></li></ul></li><li><div class="btn-group"><a class="btn default" data-wysihtml5-command="bold" title="CTRL+B" tabindex="-1" href="javascript:;" unselectable="on">Bold</a><a class="btn default" data-wysihtml5-command="italic" title="CTRL+I" tabindex="-1" href="javascript:;" unselectable="on">Italic</a><a class="btn default" data-wysihtml5-command="underline" title="CTRL+U" tabindex="-1" href="javascript:;" unselectable="on">Underline</a></div></li><li><div class="btn-group"><a class="btn default" data-wysihtml5-command="insertUnorderedList" title="Unordered list" tabindex="-1" href="javascript:;" unselectable="on"><i class="fa fa-list"></i></a><a class="btn default" data-wysihtml5-command="insertOrderedList" title="Ordered list" tabindex="-1" href="javascript:;" unselectable="on"><i class="fa fa-th-list"></i></a><a class="btn default" data-wysihtml5-command="Outdent" title="Outdent" tabindex="-1" href="javascript:;" unselectable="on"><i class="fa fa-outdent"></i></a><a class="btn default" data-wysihtml5-command="Indent" title="Indent" tabindex="-1" href="javascript:;" unselectable="on"><i class="fa fa-indent"></i></a></div></li><li><div class="btn-group"><a class="btn default" data-wysihtml5-action="change_view" title="Edit HTML" tabindex="-1" href="javascript:;" unselectable="on"><i class="fa fa-pencil"></i></a></div></li><li><div class="bootstrap-wysihtml5-insert-link-modal modal fade"><div class="modal-dialog"> <div class="modal-content"><div class="modal-header"><a class="close" data-dismiss="modal">×</a><h3>Insert link</h3></div><div class="modal-body"><input value="http://" class="bootstrap-wysihtml5-insert-link-url form-control input-xlarge"><label style="margin-top:5px;"> <input type="checkbox" class="bootstrap-wysihtml5-insert-link-target" checked="">Open link in new window</label></div><div class="modal-footer"><a href="http://pump.thesoftking.com/home-page-setting#" class="btn default" data-dismiss="modal">Cancel</a><a href="http://pump.thesoftking.com/home-page-setting#" class="btn btn-primary" data-dismiss="modal">Insert link</a></div></div></div></div><a class="btn default" data-wysihtml5-command="createLink" title="Insert link" tabindex="-1" href="javascript:;" unselectable="on"><i class="fa fa-share"></i></a></li><li><div class="bootstrap-wysihtml5-insert-image-modal modal fade"><div class="modal-dialog"> <div class="modal-content"><div class="modal-header"><a class="close" data-dismiss="modal">×</a><h3>Insert image</h3></div><div class="modal-body"><input value="http://" class="bootstrap-wysihtml5-insert-image-url form-control input-xlarge"></div><div class="modal-footer"><a href="http://pump.thesoftking.com/home-page-setting#" class="btn default" data-dismiss="modal">Cancel</a><a href="http://pump.thesoftking.com/home-page-setting#" class="btn btn-primary" data-dismiss="modal">Insert image</a></div></div></div></div><a class="btn default" data-wysihtml5-command="insertImage" title="Insert image" tabindex="-1" href="javascript:;" unselectable="on"><i class="fa fa-picture-o"></i></a></li></ul><textarea name="bottom_description" id="" cols="30" rows="5" class="wysihtml5 input-lg" style="display: none;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur corporis, debitis dolore exercitationem itaque magni minus nihil perspiciatis quaerat quasi! Aliquam consectetur delectus, distinctio error ex obcaecati officia suscipit! Dolorum. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam autem eos fugiat id iste laboriosam maxime minus natus quas qui rerum saepe veritatis, voluptatum! Autem doloribus modi placeat rem repellat! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet aut beatae cum, deleniti dolore eaque expedita labore laudantium minus mollitia nesciunt non numquam quo, rem temporibus tenetur unde velit vitae.</textarea><input type="hidden" name="_wysihtml5_mode" value="1"><iframe class="wysihtml5-sandbox" security="restricted" allowtransparency="true" frameborder="0" width="0" height="0" marginwidth="0" marginheight="0" style="background-color: rgb(255, 255, 255); border-collapse: separate; border-color: rgb(169, 169, 169); border-style: solid; border-width: 1px; clear: none; display: inline-block; float: none; margin: 0px; outline: rgb(52, 73, 94) none 0px; outline-offset: 0px; padding: 10px 16px; position: static; top: auto; left: auto; right: auto; bottom: auto; z-index: auto; vertical-align: baseline; text-align: start; box-sizing: border-box; box-shadow: none; border-radius: 6px; width: 321px; height: 137px;" src="./Petrol Pump - Home Page Setting_files/saved_resource(1).html"></iframe>
                            </div>
                        </div>
...
<script src="./csss/table-datatables-buttons.min.js.download" type="text/javascript"></script>
    ...
    <link href="./Petrol Pump - Home Page Setting_files/bootstrap-wysihtml5.css" rel="stylesheet" type="text/css">
    <script src="./Petrol Pump - Home Page Setting_files/wysihtml5-0.3.0.js.download" type="text/javascript"></script>
    <script src="./Petrol Pump - Home Page Setting_files/bootstrap-wysihtml5.js.download" type="text/javascript"></script>

    <script src="./Petrol Pump - Home Page Setting_files/components-editors.min.js.download" type="text/javascript"></script>
