<!DOCTYPE html>
<!-- saved from url=(0040)http://pump.thesoftking.com/view-reading -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <title>All Reading</title>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content" style="min-height:575px">
            <h3 class="page-title">All Reading </h3>
            <hr>
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-md-10">
                                <form method="POST" action="reading_search.php" accept-charset="UTF-8" class="form-inline margin-bottom-5"><input name="_token" type="hidden" value="jYIgDbpaJDW706f07wEEauLhsJylpRhO0qc8cjTf">
                        ...
                        <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                            ...
                            <thead>
                            <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="SL#: activate to sort column descending" style="width: 35.0104px;">SL#</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="Reading Date: activate to sort column ascending" style="width: 112.01px;">Reading Date</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" style="width: 54.0104px;">Name</th><th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="Fuel: activate to sort column ascending" style="width: 40.0104px;">Fuel</th><th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="Start Reading: activate to sort column ascending" style="width: 113.01px;">Start Reading</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="C Reading: activate to sort column ascending" style="width: 84.0104px;">C Reading</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="End Reading: activate to sort column ascending" style="width: 105.01px;">End Reading</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="Reading Sell: activate to sort column ascending" style="width: 103.01px;">Reading Sell</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="Actual Sell: activate to sort column ascending" style="width: 91px;">Actual Sell</th>
                            </tr>
                            </thead>
                            <tbody>
...
?>
                                    ...
                                    <td>0 Litter</td>
                                    <td>0 / Litter</td>
                                    <td><span class="label label-default"><b>Not Sell</b></span>
                                    </td>
                                </tr>
                                ...
                                <tr role="row" class="even">
                                    ...
                                    <td>0 Litter</td>
                                    <td>0 / Litter</td>
                                    <td><span class="label label-default"><b>Not Sell</b></span></td>
                                </tr>
                                <tr role="row" class="odd">
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12">
                            <div class="dataTables_info" id="sample_1_info" role="status" aria-live="polite">Showing 1 to 7 of 7 entries</div>
                        </div>
