...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Machine End Reading</title>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content" style="min-height:509px">
            <h3 class="page-title">Machine End Reading </h3>
            <hr>
                    ...
                    <div class="portlet-body">
                        <div id="sample_1_wrapper" class="dataTables_wrapper no-footer">
                           ...
                           <!--  <div class="row">
                            ...
                            <thead>
                            <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="ID#: activate to sort column descending" style="width: 41px;">ID#</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="Machine Name: activate to sort column ascending" style="width: 140px;">Machine Name</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="Machine Code: activate to sort column ascending" style="width: 132px;">Quantity</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="Machine Fuel: activate to sort column ascending" style="width: 125px;">Machine Fuel</th>
                                <th class="sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="Fuel Rate / Litter: activate to sort column ascending" style="width: 156px;">Fuel Rate / Litter</th>
